...
{if isset($sellers) && count($sellers) > 0}
    <h1 class="page-heading">
        <span clas="cat-name">{if isset($is_favourite_seller_page) && $is_favourite_seller_page == 1}{l s='My Favourite Store' mod='kbmarketplace'} {else}{l s='Store' mod='kbmarketplace'}{/if}</span>
