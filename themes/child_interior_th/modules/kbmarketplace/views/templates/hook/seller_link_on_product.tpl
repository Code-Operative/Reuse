...
{/if}
    ...
    <div class="kbmp-_row" style="padding-top:10px;">
        ...
        <i class="kb-material-icons shortlist_link">&#xe87d;</i><a href="javascript:addShortListSeller(this, {$id_seller});" class="sfl_product_link_{$id_seller}" style="padding-left:7px;font-size:13px;">{if isset($is_already_added) && $is_already_added == 1}{l s='Favourite Seller' mod='kbmarketplace'}{else}{l s='Mark Seller as Favourite' mod='kbmarketplace'}{/if}</a>
        {* changes over *}
   </div>
   {/if}
