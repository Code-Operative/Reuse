...
function AddCartAfterFiltere() {
    $('.js-product-miniature').hover(
        function() {
            var staticToken = $('#page').attr('data-static-token');
            var urlsPagesCart = $('#page').attr('data-urls-pages-cart');
            $(".add-to-cart-or-refresh", this).attr('action', urlsPagesCart);
            $(".token-product-list", this).attr('value', staticToken);
        },
        function() {
