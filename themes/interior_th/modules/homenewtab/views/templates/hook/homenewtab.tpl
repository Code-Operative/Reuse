...
<div class="{if $carousel_tabs == 'true'}tab-pane fade{else}none-in-tabs{/if}{if $carousel_active  == 'true' && $carousel_arrows == 'true'} nav-active{/if}"{if $carousel_tabs == 'true'} id="homenewtab"{/if}>
    <div class="container">
        {if $carousel_tabs != 'true'}
            <p class="headline-section products-title"><strong>{$homenewtab_category_name|escape:'html':'UTF-8'}</strong></p>
        {/if}
        {if $products}
