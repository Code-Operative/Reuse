<?php
/* Smarty version 3.1.34-dev-7, created on 2021-03-22 18:41:22
  from '/home/codeoperativeco/prestaoperative/themes/interior_th/modules/homefeatured/views/templates/hook/homefeatured.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6058e4d2ef39a2_35632759',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c247e68a8348f85a1b5b21ff8c068d9dbc93c428' => 
    array (
      0 => '/home/codeoperativeco/prestaoperative/themes/interior_th/modules/homefeatured/views/templates/hook/homefeatured.tpl',
      1 => 1616438450,
      2 => 'file',
    ),
  ),
...
function content_6058e4d2ef39a2_35632759 (Smarty_Internal_Template $_smarty_tpl) {
?> 
<div class="<?php if ($_smarty_tpl->tpl_vars['carousel_tabs']->value == 'true') {?>tab-pane fade<?php } else { ?>none-in-tabs<?php }
if ($_smarty_tpl->tpl_vars['carousel_active']->value == 'true' && $_smarty_tpl->tpl_vars['carousel_arrows']->value == 'true') {?> nav-active<?php }?>"<?php if ($_smarty_tpl->tpl_vars['carousel_tabs']->value == 'true') {?> id="homefeatured"<?php }?>>
    <div class="container">
   
        <?php if ($_smarty_tpl->tpl_vars['carousel_tabs']->value != 'true') {?>
            <p class="headline-section products-title"><strong><?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['homefeatured_category_name']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</strong></p>
        <?php }?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <div class="text-center" >
            <a class="more-btn btn big"  style ="background-color: #EDB263;border: none;border-radius: 4px;" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['allProductsLink']->value, ENT_QUOTES, 'UTF-8');?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Discover More Products','d'=>'Modules.Homefeatured.Shop'),$_smarty_tpl ) );?>
</a>
        </div>
