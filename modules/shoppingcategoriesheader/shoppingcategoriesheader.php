...
class SHOPPINGCATEGORIESHEADER extends Module
{
	public function __construct()
	{
		$this->name = 'shoppingcategoriesheader';
		$this->description = 'header for shopping categories on page';
		$this->tab = 'front_office_features';
		$this->version = '1.1.3';
		$this->author = 'emotionLoop';
		$this->need_instance = 0;
		$this->ps_versions_compliancy = array('min' => '1.5', 'max' => '1.7');
		$this->monolanguage_content = 'Shoppingcategoriesheader_MONOLANGUAGE';
		$this->text_editor_content = 'Shoppingcategoriesheader_TEXTEDITOR';
		$this->content_wrapper = 'Shoppingcategoriesheader_CONTENTWRAPPER';
		$this->content_wrapper_class = 'Shoppingcategoriesheader_CONTENTWRAPPER_CLASS';
		$this->content_wrapper_id = 'Shoppingcategoriesheader_CONTENTWRAPPER_ID';
		$this->bootstrap = true;
		$this->_html = '';
		...
		$this->displayName = $this->l('shopping-categories-header');
		$this->description = $this->l('header for shopping categories on page');
	...
	public function install()
	{
		...
		if (!parent::install() || !$this->registerHook('header') || !$this->registerHook('footer') || !SHOPPINGCATEGORIESHEADERModel::createTables())
			return false;
	...
	public function uninstall()
	{
		$this->_clearCache('template.tpl');
		if (!parent::uninstall()
			|| !SHOPPINGCATEGORIESHEADERModel::DropTables())
		{
	...
	public function addFilesToTemplate($path = null)
	{
		...
		$files_data = SHOPPINGCATEGORIESHEADERModel::getFilesInUse( $this->selected_store_id, $this->selected_language_id );
	...
	{
		$content_query = SHOPPINGCATEGORIESHEADERModel::getContent( $this->selected_store_id, $this->selected_language_id );
		$pre_content = '';
		$pos_content = '';
		...
		if (Tools::isSubmit('submit'.$this->name))
		{
				...
				&& (int)Configuration::get('PS_LANG_DEFAULT') == $this->selected_language_id ))
			{
				...
				if (Tools::getValue('content_text') !== false && $this->ignore_changes_content_changes == false)
					SHOPPINGCATEGORIESHEADERModel::setContent( Tools::getValue('content_text'), $this->selected_store_id, $this->selected_language_id );

				//store the files to be used
				if (Tools::getValue('headerFiles') !== false)
					SHOPPINGCATEGORIESHEADERModel::setFiles(
	...
	public function displayForm()
	{
		...
		$helper->fields_value['headerFiles[]'] = $this->processSelectFilesForMultiselect(
																SHOPPINGCATEGORIESHEADERModel::getFilesInUse( $this->selected_store_id, $this->selected_language_id )
																);
...
class SHOPPINGCATEGORIESHEADERModel extends ObjectModel
{

	public static $definition = array(
		'table' => 'shoppingcategoriesheader',
		'primary' => 'file_id',
		'multishop' => true,
		'multilang' => true,
		'fields' => array(
	...
	public static function createTables()
	{
		...
		return ( SHOPPINGCATEGORIESHEADERModel::createFilesTable()
				&& SHOPPINGCATEGORIESHEADERModel::createContentTable());
	}
