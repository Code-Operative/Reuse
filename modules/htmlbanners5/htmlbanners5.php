...
class HtmlBanners5 extends Module implements WidgetInterface
{
    ...
    protected function installSamples()
    {
        ...
        foreach ($languages as $language) {
            ...
            $slide->image[$language['id_lang']] = '2.png';
        }
        $slide->add();
        ...
        foreach ($languages as $language) {
            ...
            //$slide->url[$language['id_lang']] = 'http://www.prestashop.com/?utm_source=back-office&utm_medium=v17_htmlbanners5'
                //.'&utm_campaign=back-office-'.Tools::strtoupper($this->context->language->iso_code)
                //.'&utm_content='.(defined('_PS_HOST_MODE_') ? 'ondemand' : 'download');
            $slide->image[$language['id_lang']] = '4.png';
        }
        $slide->add();
        ...
        foreach ($languages as $language) {
            ...
            //$slide->url[$language['id_lang']] = 'http://www.prestashop.com/?utm_source=back-office&utm_medium=v17_htmlbanners5'
                //.'&utm_campaign=back-office-'.Tools::strtoupper($this->context->language->iso_code)
                //.'&utm_content='.(defined('_PS_HOST_MODE_') ? 'ondemand' : 'download');
            $slide->image[$language['id_lang']] = '3.png';
        }
        $slide->add();
        ...
        foreach ($languages as $language) {
            ...
            //$slide->url[$language['id_lang']] = 'http://www.prestashop.com/?utm_source=back-office&utm_medium=v17_htmlbanners5'
                //.'&utm_campaign=back-office-'.Tools::strtoupper($this->context->language->iso_code)
                //.'&utm_content='.(defined('_PS_HOST_MODE_') ? 'ondemand' : 'download');
            $slide->image[$language['id_lang']] = '1.png';
        }
        $slide->add();
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = array())
    {
        ...
        return array(
            'htmlbanners5' => array(
                ...
                'pause' => $config['HTMLBANNERS5_PAUSE_ON_HOVER'] ? 'true' : 'false',
