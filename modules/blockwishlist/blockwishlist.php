...
class BlockWishList extends Module
{
    ...
    public function hookHeader($params)
    {
        ...
        if ($this->context->controller instanceof ProductControllerCore ||
            ...
            $this->context->controller instanceof CartControllerCore ||
        ...
        if ($this->context->controller instanceof ProductControllerCore ||
            ...
            $this->context->controller instanceof OrderConfirmationControllerCore ||
            $this->context->controller instanceof CartControllerCore ||
            $this->context->controller instanceof BlockWishListMyWishListModuleFrontController ||
            $this->context->controller instanceof BlockWishListViewModuleFrontController ||
            $this->context->controller instanceof IndexControllerCore) {
