...
class AdminKbMpExpiryProfilesController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->toolbar_title = $this->module->l('Membership Plan Expiry Reminders.', 'AdminKbMpReminderProfilesController');

        if (Tools::getValue('id_kb_membership_reminder_profile')) {
            $this->toolbar_title = $this->module->l('Edit Expiry Reminders.', 'AdminKbMpReminderProfilesController');
        } elseif (Tools::isSubmit('add' . $this->table)) {
            $this->toolbar_title = $this->module->l('Add Expiry Reminders.', 'AdminKbMpReminderProfilesController');
        } else {
            $this->toolbar_title = $this->module->l('Membership Plan Expiry Reminders', 'AdminKbMpReminderProfilesController');
        }
        ...
        $this->_where = ' and a.reminder_type = "expiry"';
    ...
    public function renderForm()
    {
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    'label' => $this->module->l('Days (How many days after plan expiry warning mail should be sent to seller.)', 'AdminKbrcReminderProfiles'),
                    'type' => 'text',
                    'required' => true,
                    'name' => 'no_of_days',
                    'hint' => $this->module->l('How many days after plan expiry warning mail should be sent to seller.', 'AdminKbrcReminderProfiles'),
        ...
        if (Tools::getIsset('id_kb_membership_reminder_profile')) {
            ...
            $language = Language::getLanguages(false);
            foreach ($language as $lang) {
                $this->fields_value['REMINDER_EMAIL_SUBJECT'][$lang['id_lang']] = $this->module->l('Your Membership Plan is already Expired.', 'AdminKbMpReminderProfiles');
                $this->fields_value['REMINDER_EMAIL_TEMP'][$lang['id_lang']] = Tools::file_get_contents(_PS_MODULE_DIR_ . $this->kb_module_name . "/views/templates/admin/email/membership_plan_expiry_email.html");
            }
        }
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign('selected_nav', 'expiry');
