<div class="kb-content">
    <div class="kb-content-header">
        <h1>{l s='Dynamic Price Rules' mod='kbmarketplace'}</h1>
        <div class="kb-content-header-btn">
            <a href="{$new_dynamic_rule_link nofilter}" class="btn-sm btn-success" title="{l s='Click to add Price Rule' mod='kbmarketplace'}"><i class="kb-material-icons">add_circle</i>{l s='Add New Rule' mod='kbmarketplace'}</a>
