<div class="kb-content">
    <div class="kb-content-header">
        ...
        <div class="kbbtn-group kb-tright">
            ...
            <a href="{$add_zipcode_global_zone_link nofilter}" class="btn-sm btn-success" title="{l s='click to add new zone' mod='kbmarketplace'}"><i class="kb-material-icons">add_circle</i>{l s='Add New Zipcodes' mod='kbmarketplace'}</a>
