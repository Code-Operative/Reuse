...
//        return $sql;
            ...
            if ($seller_status == 0) {
                ...
                if ($results && count($results) > 0) {
                    foreach ($results as $p) {
                         ...
                         */
                        if (!$product->active) {
                            $product->active = 1 - (int) Hook::exec(
                                    'actionKbSellerProductUpdateStatus', array(
                                    'product' => $product,
                                    'id_seller' => $id_seller)
                            );
                        }
    ...
    public static function getSellerProductsByStatus(
    $id_seller, $only_count = false, $start = null, $limit = null, $orderby = null, $orderway
    = null, $active = null, $approved = null, $deleted = null, $id_shop = null, $custom_filter = '', $id_lang
    = null
    )
    {
        if ((int) $id_lang == 0) {
